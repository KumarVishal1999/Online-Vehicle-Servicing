...
if(!isset($_SESSION['is_login'])){
  if(isset($_REQUEST['rEmail'])){
    ...
    if($result->num_rows == 1){
      ...
      $msg = '<div class="alert alert-warning mt-2" role="alert"> Enter a valid email-id and password ! </div>';
    }
  }
} else {
  echo "<script> location.href='RequesterProfile.php'; </script>";
...
<body>
  <div class="mb-3 text-center mt-5" style="font-size:40px;">
    <i class="fa fa-car text-dark"></i>
    <span>Online Vehicle Servicing System</span>
  </div>
  <p class="text-center" style="font-size: 30px;"> <i class="fa fa-user text-danger"></i> <span>User
      Login</span>
  </p>
